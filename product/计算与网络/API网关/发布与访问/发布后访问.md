在服务完成发布后，您就可以通过服务的子域名，或您已经绑定的自定义域名访问 API 了。服务提供的子域名形如 http://{your-unique-key}.{region}.apigateway.qcloud.com，在发布后，根据发布环境的不同，具体 API 的访问路径形如 http://{your-unique-key}.{region}.apigateway.qcloud.com/release 。
