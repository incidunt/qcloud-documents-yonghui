...
开始实践服务注册发现功能前，请确保已完成了 [SDK 下载](/document/product/649/20231)。
...
将打包好的 FatJar 程序包上传到 TSF 控制台，进行部署操作，无需关心额外配置。部署相关操作可参考云平台官网上 TSF 的 [虚拟机应用部署组](/document/product/649/15524) 或 [容器应用部署组](/document/product/649/15525) 操作手册。 
